package com.example.fitmvp.chat.adapter;
...
import com.example.fitmvp.chat.controller.ChatItemController;
                ...
                userInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                    ...
                    public void gotResult(int status, String desc, Bitmap bitmap) {
                        if (status == 0) {
                            ...
                            holder.headIcon.setImageResource(R.drawable.default_portrait36);
                        }
                    }
                });
            } else {
