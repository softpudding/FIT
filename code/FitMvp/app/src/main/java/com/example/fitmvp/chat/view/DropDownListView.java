package com.example.fitmvp.chat.view;
/**
 * DropDownListView
 *
 */
...
import com.example.fitmvp.chat.utils.IdHelper;
...
//        int[] dropDownAttrArray = IdHelper.getResourceDeclareStyleableIntArray(context, "drop_down_list_attr");
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DropDownListView,mDefStyle,0);
        isDropDownStyle = true;
        a.recycle();
//        if (dropDownAttrArray != null) {
//            TypedArray ta = context.obtainStyledAttributes(attrs,a, mDefStyle, 0);
//            isDropDownStyle = true;
//            ta.recycle();
//        }
    }
